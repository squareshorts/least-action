...
\input{tables/table_semantic_source_audit.tex}

\input{tables/table_multisource_semantic_scores.tex}
...
\input{tables/table_robustness_rmse.tex}
...
\section{Severe Benchmark}
\label{sec:supp-severe-benchmark}

Table~\ref{tab:severe-benchmark} separates raw trajectory prediction from mechanistic interpretability. Flexible descriptive baselines summarize empirical path shape directly. Action models provide fitted competitor attraction and action-gap quantities that can be related to semantic and perceptual competition.
